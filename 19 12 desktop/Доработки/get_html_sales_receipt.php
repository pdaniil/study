...
$order_items_id = isset($_GET["order_items"]) ? $_GET["order_items"] : array();
$order_items_id_str = '';
if(!empty($order_items_id)) {
    $order_items_id = json_decode($order_items_id, true);
...
if($order_items_id_str !== '') {
    $SELECT_ORDER_ITEMS .= "AND `id` IN ($order_items_id_str)";
}
...
<TR CLASS=R1>
<TD><SPAN></SPAN></TD>
<TD CLASS="R36C1" COLSPAN=6><SPAN STYLE="white-space:nowrap;max-width:0px;">Дата выдачи</SPAN></TD>
<TD CLASS="R36C19" COLSPAN=3><SPAN><?= date('Y-m-d'); ?></SPAN></TD>
<TD><SPAN></SPAN></TD>
<TD><SPAN></SPAN></TD>
<TD></TD>
</TR>
